...
SAMPLE_CONTACTS = [
    ContactCreate(
        ...
        addresses=[
            AddressInput(type="home", city="San Francisco", state="CA", country="USA"),
            AddressInput(
                type="work",
    ...
    ContactCreate(
        ...
        addresses=[AddressInput(type="work", city="Arlington", state="VA", country="USA")],
    ),
    ContactCreate(
        first_name="Alan",
        last_name="Turing",
        ...
        addresses=[AddressInput(type="home", city="London", country="UK")],
    ),
]
